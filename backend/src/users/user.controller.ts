...
newUser.generateSlug()
  ...
  async getUser(
    ...
    try {
      ...
      return new ResponseData<User>(foundUser, HttpStatus.SUCCESS, HttpMessage.SUCCESS);
    } catch (error) {
      return new ResponseData<User>(null, HttpStatus.ERROR, HttpMessage.ERROR);
    }
  }
  ...
  async deleteUser(
    ...
    try {
      ...
      return new ResponseData<User>(deletedUser, HttpStatus.SUCCESS, HttpMessage.SUCCESS);
    } catch (error) {
      return new ResponseData<User>(null, HttpStatus.ERROR, HttpMessage.ERROR);
    }
  }
